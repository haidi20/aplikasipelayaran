                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 items-center mx-5 lg:mx-20 gap-10 lg:gap-20">
                    <div class="2xl:flex 2xl:justify-end">
                        <div class="bg-gradient-to-b from-white to-whiteblue px-2.5 py-2.5 pb-8 max-w-fit rounded shadow-lg select-none">
                            <img class="h-250px w-800px brightness-75" src="Image/dashboard.png" alt="Dashboard">
                        </div>
                    </div>
                    <div class="mx-auto">
                ...
                <div id="carousel" data-carousel="slide">
                    ...
                    <div class="absolute left-1/2 xl:left-[45%] bottom-full select-none">
                        <div class="group/gallery px-2.5 py-2.5 pb-8 bg-gradient-to-b from-white to-whiteblue w-1000px h-350px max-w-md xl:max-w-lg shadow-lg hidden duration-700 ease-in-out" data-carousel-item>
                            <img class="w-1000px h-full brightness-75 group-hover/gallery:brightness-100 transition" src="Image/absensi.png" alt="Absensi">
                            <div class="group/desc justify-center flex items-center invisible group-hover/gallery:visible">
                                <p class="text-dark group-hover/desc:text-dark-tp font-space-grotesk mt-1 transition uppercase">Absensi</p>
                            </div>
                        </div>
                        <div class="group/gallery px-2.5 py-2.5 pb-8 bg-gradient-to-b from-white to-whiteblue w-1000px h-350px max-w-md xl:max-w-lg shadow-lg hidden duration-700 ease-in-out" data-carousel-item="active">
                            <img class="w-1000px h-full brightness-75 group-hover/gallery:brightness-100 transition" src="Image/roster.png" alt="Roster">
                            <div class="group/desc justify-center flex items-center invisible group-hover/gallery:visible">
                                <p class="text-dark group-hover/desc:text-dark-tp font-space-grotesk mt-1 transition uppercase">Roster</p>
                            </div>
                        </div>
                        <div class="group/gallery px-2.5 py-2.5 pb-8 bg-gradient-to-b from-white to-whiteblue w-1000px h-350px max-w-md xl:max-w-lg shadow-lg hidden duration-700 ease-in-out" data-carousel-item>
                            <img class="w-1000px h-full brightness-75 group-hover/gallery:brightness-100 transition" src="Image/job-order.png" alt="job-order">
                            <div class="group/desc justify-center flex items-center invisible group-hover/gallery:visible">
                                <p class="text-dark group-hover/desc:text-dark-tp font-space-grotesk mt-1 transition uppercase">Job Order</p>
                            </div>
                        </div>
                        <div class="group/gallery px-2.5 py-2.5 pb-8 bg-gradient-to-b from-white to-whiteblue w-1000px h-350px max-w-md xl:max-w-lg shadow-lg hidden duration-700 ease-in-out" data-carousel-item>
                            <img class="w-1000px h-full brightness-75 group-hover/gallery:brightness-100 transition" src="Image/laporan-joborder.png" alt="laporan-joborder">
                            <div class="group/desc justify-center flex items-center invisible group-hover/gallery:visible">
                                <p class="text-dark group-hover/desc:text-dark-tp font-space-grotesk mt-1 transition uppercase">Laporan Job Order</p>
